...
*   **Agrimonia Dataset**: Malò, M. S., et al. (2021). *Agrimonia: a dataset of air quality and meteorological data for Northern Italy*.
*   **Oxford COVID-19 Government Response Tracker (OxCGRT)**: Hale, T., et al. (2021). "A global panel database of pandemic policies". *Nature Human Behaviour*.
